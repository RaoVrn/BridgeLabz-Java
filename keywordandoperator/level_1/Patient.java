...
class PatientDetails {
    ...
    public PatientDetails(String name, int age, String ailment, int patientID) {
        this.name = name;
        this.age = age;
...
public class Patient {
    public static void main(String[] args) {
        PatientDetails p = new PatientDetails("Varun", 21, "Fever", 501);
        p.display(p);
        PatientDetails.getTotalPatients();
    }
}
